...
class SiteServiceProvider extends ServiceProvider
{
    ...
    {
        $this->basePath = base_path('vendor/backpack/crud/src');
    ...
    public function boot(\Illuminate\Routing\Router $router)
    {
        ...
        $this->loadTranslationsFrom(realpath($this->basePath.'/resources/lang'), 'backpack');
        $this->loadConfigs();
    ...
    {
        $error_views = [$this->basePath.'/resources/error_views' => resource_path('views/errors')];
        $backpack_views = [$this->basePath.'/resources/views' => resource_path('views/vendor/backpack')];
        $backpack_public_assets = [$this->basePath.'/public' => public_path()];
        $backpack_lang_files = [$this->basePath.'/resources/lang' => resource_path('lang/vendor/backpack')];
        $backpack_config_files = [$this->basePath.'/config' => config_path()];
        $elfinder_files = [
            $this->basePath.'/config/elfinder.php'      => config_path('elfinder.php'),
            $this->basePath.'/resources/views-elfinder' => resource_path('views/vendor/elfinder'),
        ];

        // sidebar_content view, which is the only view most people need to overwrite
        $backpack_menu_contents_view = [
            $this->basePath.'/resources/views/base/inc/sidebar_content.blade.php'      => resource_path('views/vendor/backpack/base/inc/sidebar_content.blade.php'),
            $this->basePath.'/resources/views/base/inc/topbar_left_content.blade.php'  => resource_path('views/vendor/backpack/base/inc/topbar_left_content.blade.php'),
            $this->basePath.'/resources/views/base/inc/topbar_right_content.blade.php' => resource_path('views/vendor/backpack/base/inc/topbar_right_content.blade.php'),
        ];
        $backpack_custom_routes_file = [$this->basePath.$this->customRoutesFilePath => base_path($this->customRoutesFilePath)];

        // calculate the path from current directory to get the vendor path
        $vendorPath = dirname($this->basePath, 3);
    ...
    public function setupRoutes(Router $router)
    {
        ...
        $routeFilePathInUse = $this->basePath.$this->routeFilePath;
    ...
    public function loadViewsWithFallbacks()
    {
        ...
        $this->loadViewsFrom(realpath($this->basePath.'/resources/views/base'), 'backpack');
        $this->loadViewsFrom(realpath($this->basePath.'/resources/views/crud'), 'crud');
    }

    public function loadConfigs()
    {
        // use the vendor configuration file as fallback
        $this->mergeConfigFrom($this->basePath.'/config/backpack/crud.php', 'backpack.crud');
        $this->mergeConfigFrom($this->basePath.'/config/backpack/base.php', 'backpack.base');
    ...
    {
        require_once $this->basePath.'/helpers.php';
    }
}
